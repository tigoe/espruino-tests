...
SPI2.setup({baud:3200000, mosi:B15});			// initialize SPI on pin B15
var ledCount = 13;									// number of neoPixels you have
var ledArray = new Uint8Array(ledCount*3);	// array of R, G, B values
